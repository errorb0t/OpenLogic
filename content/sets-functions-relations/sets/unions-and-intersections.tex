...
wie in \olref{fig:union}, wobei der hervorgehobene Bereich die
...
Schließlich können wir über die Menge aller Elemente aus~$A$ nachdenken,
die nicht aus~$B$ sind. Wir können dies wie in \olref{difference} darstellen.

\begin{figure}
  \olasset{assets/diagrams/difference.tikz}
  \caption{Die Differenz $A \setminus B$ von zwei Mengen ist die Menge der
