...
The material is divided into three parts. \Olref[sfr][][]{teil}
...
In \olref[fol][][]{teil}, we turn to first-order logic. We will define
...
In \olref[tur][][]{teil}, we connect logic with computability. Again,
...
that can be used to illustrate the material in \olref[tur][][]{teil}.
